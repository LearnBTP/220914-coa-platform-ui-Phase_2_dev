sap.ui.define([
    ...
    "sap/ui/Device",
    "coa/rfidonhand/model/models",
    "coa/rfidonhand/localService/mockserver",
    ...
    function (UIComponent, Device, models, MockServer, ODataModel, MessageBox, UriParameters) {
        ...
        return UIComponent.extend("coa.rfidonhand.Component", {
            metadata: {
                manifest: "json"
            },
            ...
            init: async function () {
                ...
                if (isMockServer) {
                    ...
                    Promise.all(myPromises).catch(function (oError) {
                        ...
                        appODataModel = new ODataModel('/mock/rfid-tt', {
                            useBatch: true,
                        ...
                        this.initializeApp(appODataModel, "MainModel", ["RfidOnHandTTModify", "ApproveRfidOnHandTT", "RfidOnHandTTReadOnly"],'corp-apps');
            ...
            validatePromiseAndInitApp: function (values) {
                ...
                if ((values[0] && values[0] !== "") &&
                    ...
                    if (values[1].decodedJWTToken.origin === "corp-apps") {
                        sPath = "/coa-api/v1/coa/rfid-services/rfid-tt/";
                        sPathChangelog = "/coa-api/v2/coa/changelog-services/changelog/";
                    } else {
                        sPath = "/coa-api-ext/v1/ext/coa/rfid-services/rfid-tt/";
                    ...
                    if (scopes.find(e => e === "RfidOnHandTTReadOnly" || e === "RfidOnHandTTModify" || e === "ApproveRfidOnHandTT")) {
            ...
            initializeApp: function (oDataModel, ModelName, scopes,sOrigin) {
                ...
                if (scopes && scopes.length !== 0) {
                    // Modify Flag
                    if (scopes.find(e => e === "RfidOnHandTTModify")) {
                    ...
                    // Display Flag
                    if (scopes.find(e => e === "RfidOnHandTTReadOnly")) {
