		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "RFID on Hand",
									"targetURL": "#coarfidonhand-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"coarfidonhand-display": {
								"semanticObject": "coarfidonhand",
								"action": "display",
								"description": "A COA Fiori application.",
								"title": "RFID on Hand",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=coa.rfidonhand",
									"url": sap.ui.require.toUrl("coa/rfidonhand")
								}
							}
						}
					}
