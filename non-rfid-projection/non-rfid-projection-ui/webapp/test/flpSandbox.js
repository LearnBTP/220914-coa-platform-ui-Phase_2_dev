		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Non-Rfid-Projection",
									"targetURL": "#comapplecoanonrfidprojectionui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplecoanonrfidprojectionui-display": {
								"semanticObject": "comapplecoanonrfidprojectionui",
								"action": "display",
								"description": "Non-Rfid-Projection",
								"title": "Non-Rfid-Projection",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.apple.coa.nonrfidprojectionui",
									"url": sap.ui.require.toUrl("com/apple/coa/nonrfidprojectionui")
								}
							}
						}
					}
