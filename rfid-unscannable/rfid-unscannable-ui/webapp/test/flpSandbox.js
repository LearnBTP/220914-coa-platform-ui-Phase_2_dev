		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "RFID Unscannable",
									"targetURL": "#comapplecoarfidunscannableui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplecoarfidunscannableui-display": {
								"semanticObject": "comapplecoarfidunscannableui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.apple.coa.rfidunscannableui",
									"url": sap.ui.require.toUrl("com/apple/coa/rfidunscannableui")
								}
							}
						}
					}
