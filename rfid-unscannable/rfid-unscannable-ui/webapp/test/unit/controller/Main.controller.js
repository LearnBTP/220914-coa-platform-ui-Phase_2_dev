...
sap.ui.define([
	"comapplecoa/rfid-unscannable-ui/controller/Main.controller",
    "sap/ui/core/UIComponent",
    "sap/ui/model/json/JSONModel",
], function (Controller,Component,JSONModel) {
	"use strict";

	QUnit.module("RFID Unscannable Main Controller", {
        beforeEach: function () {
    ...
    QUnit.test("I Should test Ajax URL", function(assert){
        ...
        this.oController.getSplitDeleteAjaxUrl();
        this.oController.getGenerateUnscannableURL();
