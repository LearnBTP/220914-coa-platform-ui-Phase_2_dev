		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#coaannotationrfidannotationui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"coaannotationrfidannotationui-display": {
								"semanticObject": "coaannotationrfidannotationui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=coa.annotation.rfidannotationui",
									"url": sap.ui.require.toUrl("coa/annotation/rfidannotationui")
								}
							}
						}
					}
