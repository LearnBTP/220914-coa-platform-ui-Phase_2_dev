		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "COA Logon",
									"targetURL": "#logoncoalogonui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logoncoalogonui-display": {
								"semanticObject": "logoncoalogonui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logon.coalogonui",
									"url": sap.ui.require.toUrl("logon/coalogonui")
								}
							}
						}
					}
