		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#coacoalineplanui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"coacoalineplanui-display": {
								"semanticObject": "coacoalineplanui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=coa.coalineplanui",
									"url": sap.ui.require.toUrl("coa/coalineplanui")
								}
							}
						}
					}
