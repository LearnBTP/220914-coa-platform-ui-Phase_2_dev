		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sub Line",
									"targetURL": "#coasublineui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"coasublineui-display": {
								"semanticObject": "coasublineui",
								"action": "display",
								"description": "A SAP UI5 application.",
								"title": "Sub Line",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=coasublineui",
									"url": sap.ui.require.toUrl("coasublineui")
								}
							}
						}
					}
