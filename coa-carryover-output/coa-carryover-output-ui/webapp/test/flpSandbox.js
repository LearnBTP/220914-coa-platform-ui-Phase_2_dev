		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Carryover Output Fiori App",
									"targetURL": "#coacoacarryoveroutputui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"coacoacarryoveroutputui-display": {
								"semanticObject": "coacoacarryoveroutputui",
								"action": "display",
								"description": "Carryover Output Fiori App",
								"title": "Carryover Output Fiori App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=coa.coacarryoveroutputui",
									"url": sap.ui.require.toUrl("coa/coacarryoveroutputui")
								}
							}
						}
					}
