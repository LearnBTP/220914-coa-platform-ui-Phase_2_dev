		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "AQID Mapping",
									"targetURL": "#coaaqidmappingui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"coaaqidmappingui-display": {
								"semanticObject": "coaaqidmappingui",
								"action": "display",
								"description": "A AQID Fiori application.",
								"title": "AQID Mapping",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=coa.aqidmappingui",
									"url": sap.ui.require.toUrl("coa/aqidmappingui")
								}
							}
						}
					}
