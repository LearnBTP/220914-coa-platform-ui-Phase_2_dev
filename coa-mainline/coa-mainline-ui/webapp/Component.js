sap.ui.define([
    ...
    "sap/ui/Device",
    "coamainlineui/model/models",
    "coamainlineui/localService/mockserver",
    ...
    function (UIComponent, Device, models, MockServer, ODataModel, MessageBox, UriParameters) {
        ...
        return UIComponent.extend("coamainlineui.Component", {
            metadata: {
                manifest: "json"
            },
            /**
            ...
            initMockServer: function (NoAuth) {
                if (NoAuth) {
                    ...
                    this.initializeApp(true, ['MainLineModify', 'MainLineReadOnly'], "", "corp-apps");
                }
            },
