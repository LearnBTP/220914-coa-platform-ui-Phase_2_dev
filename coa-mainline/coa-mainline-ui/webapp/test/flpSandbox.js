		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "COA Main Line",
									"targetURL": "#coamainlineui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"coamainlineui-display": {
								"semanticObject": "coamainlineui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=coamainlineui",
									"url": sap.ui.require.toUrl("coamainlineui")
								}
							}
						}
					}
