		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "COA Line Simulation",
									"targetURL": "#comapplecoacoalinesimulationui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplecoacoalinesimulationui-display": {
								"semanticObject": "comapplecoacoalinesimulationui",
								"action": "display",
								"description": "CarryOver Platform Automation Line Simulation",
								"title": "COA Line Simulation",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.apple.coa.coalinesimulationui",
									"url": sap.ui.require.toUrl("com/apple/coa/coalinesimulationui")
								}
							}
						}
					}
