		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Non RFID Transfer Tracker",
									"targetURL": "#comapplecoacoanonrfidtrackerui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplecoacoanonrfidtrackerui-display": {
								"semanticObject": "comapplecoacoanonrfidtrackerui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.apple.coa.coanonrfidtrackerui",
									"url": sap.ui.require.toUrl("com/apple/coa/coanonrfidtrackerui")
								}
							}
						}
					}
