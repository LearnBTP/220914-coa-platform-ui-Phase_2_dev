		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Map CM, Site to GH Site ",
									"targetURL": "#COAcoamapghsiteui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"COAcoamapghsiteui-display": {
								"semanticObject": "COAcoamapghsiteui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=COA.coamapghsiteui",
									"url": sap.ui.require.toUrl("COA/coamapghsiteui")
								}
							}
						}
					}
