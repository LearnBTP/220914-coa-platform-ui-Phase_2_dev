		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "NPI Program",
									"targetURL": "#comapplecoacoanpiprogramui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplecoacoanpiprogramui-display": {
								"semanticObject": "comapplecoacoanpiprogramui",
								"action": "display",
								"description": "NPI Program",
								"title": "NPI Program",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.apple.coa.coanpiprogramui",
									"url": sap.ui.require.toUrl("com/apple/coa/coanpiprogramui")
								}
							}
						}
					}
